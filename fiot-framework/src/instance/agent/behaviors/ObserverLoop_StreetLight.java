 ...
 * @version 1.0
 */
public class ObserverLoop_StreetLight extends ObserverLoop {

    public ObserverLoop_StreetLight(Agent a) {
        super(a);
    }
    ...
    public double readResultSimulation() throws FIPAException {
        ...
        while (msgFromControl == null) {
            ...
            if (msg != null) {
                ...
                double totalEnergy = Double.parseDouble(itens[4]);
                ...
                double fitnessCalculated = (1.0 * percentualPeople)-(0.6 * percentualTrip)-(0.4 * percentualEnergy);
                ...
                /*APAGAR - PROVISORIO!!!*/
                this.setCompletedPeople(percentualPeople);
                this.setTotaltriptime(percentualTrip);
                this.setTotalenergy(percentualEnergy);
                //APAGAR ATE AQUI
