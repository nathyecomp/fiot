 ...
 * @author nathi_000
 */
public class IfElseControlP10 implements Controller{
 ...
 //   IndividualNeuralControler indi;
    ...
    public IfElseControlP10(File file) throws FileNotFoundException, IOException {
...
if(this.getLightingSensor() == 0.0 && this.getMotionSensor()== 1.0 && this.getWirelessReceiver() == 0.0 && this.getPreviousListeningDecision() == 0.0){
 // this.setLightDecision(YYY);
 // this.setWirelessTransmitter(YYY);
 // this.setListeningDecision(YYY);
}
