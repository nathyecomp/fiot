 ...
 * @author nathi_000
 */
public class IfElseControlP07 implements Controller{
 ...
 //   IndividualNeuralControler indi;
    ...
    public IfElseControlP07(File file) throws FileNotFoundException, IOException {
   ...
   if(this.getLightingSensor() == 0.0 && this.getMotionSensor()== 0.0 && this.getWirelessReceiver() == 0.0 && this.getPreviousListeningDecision() ==0.0){
        this.setLightDecision(0.5); //0/0.5/1.0
        this.setWirelessTransmitter(0.0); //0/0.5/1.0
        this.setListeningDecision(1.0); //0/1
    }
        ...
        this.setLightDecision(1.0); //0/0.5/1.0
        this.setWirelessTransmitter(1.0); //0/0.5/1.0
